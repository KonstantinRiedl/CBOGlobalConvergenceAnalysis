...
if savevideo
    if anisotropic
        video = VideoWriter([main_folder(),'/EnergyBasedCBOAnalysis/images_videos/VandVar_',objectivefunction,'_anisotropic'],'MPEG-4');
    else
        video = VideoWriter([main_folder(),'/EnergyBasedCBOAnalysis/images_videos/VandVar_',objectivefunction,'_isotropic'],'MPEG-4');
    end
    video.FrameRate = 8;
    open(video);
    ...
    % save parameters
    if anisotropic
        save([main_folder(),'/EnergyBasedCBOAnalysis/images_videos/VandVar_',objectivefunction,'_anisotropic_param'], 'objectivefunction', 'E', 'anisotropic', 'vstar', 'd', 'T', 'dt', 'N', 'alpha', 'lambda', 'gamma', 'learning_rate', 'sigma', 'V0mean', 'V0std')
    else
        save([main_folder(),'/EnergyBasedCBOAnalysis/images_videos/VandVar_',objectivefunction,'_isotropic_param'], 'objectivefunction', 'E', 'anisotropic', 'vstar', 'd', 'T', 'dt', 'N', 'alpha', 'lambda', 'gamma', 'learning_rate', 'sigma', 'V0mean', 'V0std')
    end
end
