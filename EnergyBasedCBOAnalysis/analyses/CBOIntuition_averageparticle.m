...
if ~anisotropic
    ...
    Vex = [[4;0],[4;4]/sqrt(2),[0;4],[-4;4]/sqrt(2),[-1.5;-1.5],[-1.5;0]*sqrt(2),[1.5;-1.5],[0;-1.5]*sqrt(2)];
end
[~, NUM_EX] = size(Vex);
N = N+NUM_EX;
...
if pdfexport
    ...
    %print(f,['EnergyBasedCBOAnalysis/images_videos/CBOIntuition_',objectivefunction],'-dpdf');

    if anisotropic
        filename = ['CBOIntuition_',objectivefunction,'_anisotropicN',num2str(N),'sigma',num2str(100*sigma),'div100'];
    else
