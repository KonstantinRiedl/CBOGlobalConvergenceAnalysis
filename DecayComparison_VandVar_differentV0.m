...
for m = 1:length(V0mu)
    ...
    if normalized
        normal_Vstar = 1/2*sum((V0-vstar/N).^2)/N;
...
if pdfexport
    ...
    % save parameters
    save(['images_videos/JandVarforVariousV0_',objectivefunction,'_param'], 'objectivefunction', 'E', 'vstar', 'd', 'T', 'dt', 'N', 'alpha', 'lambda', 'gamma', 'learning_rate', 'sigma', 'V0mu', 'V0var')
end
