...
% v_alpha
v_alpha_norm = 1.1; % 1.1, 0.9, 1               %%%%%%%%%%% can be modified
v_alpha = v_alpha_norm*[1.5,1]/sqrt(3.25);
%v_alpha = v_alpha_norm*[1,0]/sqrt(1);
...
if pdfexport
    ...
    filename = ['Prop19_','v_alpha_norm',num2str(100*v_alpha_norm),'div100','sigma',num2str(100*sigma),'div100'];
    
    print(f,['images_videos/', filename],'-dpdf');

    % save parameters
    save(['images_videos/', filename], 'sigma', 'v_alpha_norm', 'v_alpha', 'c')
