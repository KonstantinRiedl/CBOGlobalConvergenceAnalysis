...
if pdfexport
    ...
    print(f,['images_videos/ObjectiveFunction2d_',objectivefunction],'-dpdf');

    % save parameters
    save(['images_videos/ObjectiveFunction2d_',objectivefunction,'_param'], 'objectivefunction', 'E', 'vstar', 'd')
